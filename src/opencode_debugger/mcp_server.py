...
Usage:
    ...
    python -m opencode_debugger.mcp_server

    # Or via entry point
    opencode-debugger-mcp
"""
...
from opencode_debugger.core.session import SessionManager, SessionState
from opencode_debugger.models.dap import LaunchConfig, SourceBreakpoint
...
async def debug_set_breakpoints(
    ...
    file_path: str,
    lines: list[int],
    conditions: Optional[list[Optional[str]]] = None,
) -> dict[str, Any]:
